...
dataf <- gather(DAAG::vlt, key="window", value="symbol", window1:window3) 
...
```{r}
df = read.csv("/Users/daargov/OneDrive/Documents/Graduate School/Spring 2018/Visualizations/Death2015.txt", sep="\t")
```
```{r}
head(df)
```
